...
/**
 * Script para extrair seletores CSS de elementos comuns
 * Use em browsers com DevTools: document.querySelectorAll('seu-seletor')
 */
  ...
  Object.entries(categorySelectors).forEach(([key, selectorsArray]) => {
    ...
    selectorsArray.forEach((selector) => {
      ...
      if (result.found && !found) {
        ...
        if (result.element.className) console.log(`     Classes: ${result.element.className}`);
